...
<div style="margin-top:60px;">
  <div class="text-center" style="font-size:40px">
    <b><?php echo gethostname(); ?> is restarting.</b><br><br>Please go <a href="./">here</a> once<br>the computer restarts.<br><br><i class="fa fa-power-off" style="font-size:100px" aria-hidden="true"></i>
  </div>
</div>
